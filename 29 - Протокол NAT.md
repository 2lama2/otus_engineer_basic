...
![Pics](https://github.com/2lama2/otus_engineer_basic/blob/2fb2262a8d45c86153dc306b0b9c7f45fec4f372/pics/Pasted%20image%2020220607231421.png)
...
* Настроим маршрутизаторы согласно таблице адресации:
...
1. С Linux2 выполним **`PING`** до адреса **`209.165.200.1`**, находящегося в "Интернет-сегменте" и отобразим NAT-таблицу на **`R1`**:
	```
...
2. С Linux1 выполним **`PING`** до адреса **`209.165.200.1`**, находящегося в "Интернет-сегменте" и отобразим NAT-таблицу на **`R1`**:
